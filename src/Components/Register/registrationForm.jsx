    ...
    const handleChange = (e) => {
        ...
        switch (name) {
            ...
            case 'phoneNumber':
                ...
                break;
            case 'zipCode':
                isValid = /^\d{5,7}$/.test(value);
                break;
            case 'email':
                isValid = /@gmail\.com$|@outlook\.com$|\.edu$|@yahoo\.com$/.test(value);
                break;
            case 'username':
    ...
    return (
        ...
        <div className="registration-container">
                ...
                <div className="form-section">
                    ...
                    <input type="text" name="zipCode" value={formData.zipCode} onChange={handleChange} required maxLength="7" />
